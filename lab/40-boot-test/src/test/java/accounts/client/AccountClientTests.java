...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		ResponseEntity<Beneficiary> deletedBeneficiary =  restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);

		assertThat(deletedBeneficiary.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
