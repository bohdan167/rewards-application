...
public class AccountClientTests {
	...
	public void createAccount() {
		...
		Account account = new Account("123123123", "John Doe"); // to trigger handleAlreadyExists method
		...
		URI newAccountLocation = restTemplate.postForLocation(BASE_URL + "/accounts", account, account.getClass());
